						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="order_manage"></i> 업체 정보 새로 등록
								</h3>
							</div>
									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td><input type="text" name="deliStartTime" > ~ 
												<input type="text" name="deliEndTime" ></td>
											</tr>
											<tr>
												<td width=100>주소</td>
												<td width=500 >
											...
											<tr>
												...
												<td width=500>
												<div class="wrap">
												<textarea id="str1" name="content" maxlength="100"></textarea>
