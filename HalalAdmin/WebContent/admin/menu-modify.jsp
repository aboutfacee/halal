...
<%
	...
	adminVo vo=dao.findMenuInfo(priority);				//특정 priority의 해당 정보를 가져옴
	String menuNo = vo.getMenuNo();
	session.setAttribute("pre_priority",priority);		//원래의 priority 값을 저장
	session.setAttribute("menuNo",menuNo);		//원래의 질문 값을 저장
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="order_manage"></i> 메뉴 정보 수정
								</h3>
							</div>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered table-hover table-striped">
										...
										<tr>
												<td width=5>메뉴 명</td>
												<td><input type="text" name="title" value=<%=vo.getMenuName()%>></td>
											</tr>
											<tr>
												<td width=5>우선 순위</td>
											...
											<tr>
												<td width=5>메뉴 가격</td>
												<td><input type="text" name="price" value=<%=vo.getMenuPrice()%>></td>
											</tr>
											<tr>
												<td width=100>요약 소개글</td>
												<td width=500 >
												<div class="wrap">
												<textarea id="str1" name="summary" maxlength="100" ><%=vo.getMenuSumm()%></textarea>
											...
											<tr>
												...
												<td width=500>
												<div class="wrap">
												<textarea id="str2" name="content" maxlength="100" ><%=vo.getMenuContent()%></textarea>
												<span id="counter2">###</span>
												</div>
												</td>
											<tr>
												<td width=5>메뉴Image</td>
												<td><input type="file" name="file1" value=<%=vo.getMenuImg() %>></td>
											</tr>
										</tbody>
									</table>
								</div>
