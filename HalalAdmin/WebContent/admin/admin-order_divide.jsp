...
<%
	...
	int pagenum = 1;  // 페이지 번호
	 ...
	 int size = 10;		//한페이지에 보여질 개수
	 int tot;
	 int cnt = dao.OrderCount();
	 tot = cnt/size;
	 if(cnt%size != 0){
	  tot++;
	 }
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						...
						<div class="col-lg-4">
							<div class="panel panel-default">
								...
								<form action=orderFilter.jsp>
									...
									<select
										name="order_state" class="order_base">
										<option value="">선택하세요</option>
										<option value="company_name">주문</option>
										<option value="order_time">확인</option>
										<option value="delivery">완료</option>
									</select> 업체명<input type="text" name="name"/><input type="button" value="검색">	
						...
						<div class="panel-body">
								...
								<table class="table table-bordered table-hover table-striped">
									...
									<tbody>
										<%
											...
											%>
											<tr>
												<td width=60 align ="center" name="orderNo"><%=vo.getOrderNo()%></td>
							...
							<%
								for(int i=1; i<=tot; i++ ){	%>
								<a href="admin-order.jsp?page=<%=i%>"><%=i%></a>
							<%} %>
							</div>
						</div>
					</div>
