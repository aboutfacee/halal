...
<%
	...
	adminVo vo=dao.findFaqInfo(priority);				//특정 priority의 해당 정보를 가져옴
	String faqNo = vo.getFaqNo();
	session.setAttribute("pre_priority",priority);		//원래의 priority 값을 저장
	session.setAttribute("faqNo",faqNo);		//원래의 질문 값을 저장
									...
									<table class="table table-bordered table-hover table-striped">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" name="question" value=<%=vo.getFaqQuestion()%> ></td>
											</tr>
											<tr>
												<td width=5>우선 순위</td>
											...
											<tr>
												...
												<td><input type="text" name="answer" value=<%=vo.getFaqAnswer()%>></td>
											</tr>
										</tbody>
									</table>
								</div>
